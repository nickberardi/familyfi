...
.PHONY: setup hooks dev test test-unit test-coverage test-api test-api-breaking test-api-version test-integration test-browser spike lint typecheck build \
