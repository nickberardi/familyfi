...
export default defineConfig({
  test: {
    ...
    coverage: {
       ...
       * takes random paths and moves it by about a point and a half between runs; the
       * named scenarios in tests/integration/reconcile-paths.test.ts hold the rest.
       */
      thresholds: {
        lines: 83,
        statements: 78,
