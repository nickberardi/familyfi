...
const ACCESS: Record<string, Entry> = {
  ...
  "POST /api/v1/accounts": { access: "session", question: ACCOUNT_ADMIN },
  ...
  "PUT /api/v1/accounts/{id}/password": { access: "session", question: "Any signed-in adult can reset any other adult's password, an administrator's included." },
